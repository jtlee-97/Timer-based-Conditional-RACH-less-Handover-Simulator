...
strategies_all = {'Strategy A', 'Strategy B', 'Strategy C', 'Strategy D', 'Strategy T'};
...
display_names = {'Set 1', 'Set 2', 'Set 3', 'Set 4', 'Set 5'}; 
colors_all = { ...
    [0, 0.447, 0.741], [0.85, 0.325, 0.098], [0.635, 0.078, 0.184], [0.635 0.078 0.184], [0.494, 0.184, 0.556]};

% lineStyles_all = {'--',':','--','--','--','-.', '-.', '-.', '-'};
% markerStyles_all = {'o', 'v', '^', 'square', 'diamond', 'pentagram', 'hexagram', 'x'};
lineStyles_all = {'--','--','-.','-.','-'};
markerStyles_all = {'o', 'v', '^', 'square', 'diamond'};
...
for s = 1:1  % 1: DenseUrban, 2: Rural
    for i = 1:length(strategies_all)
