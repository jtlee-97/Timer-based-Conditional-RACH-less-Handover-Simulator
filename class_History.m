...
classdef class_History
    properties
        ...
        RACH_RB_EQ_SUM = [];
        DYN_GRANT_TX_COUNT = [];
        DYN_GRANT_FAIL_COUNT = [];
        DYN_GRANT_FALLBACK_COUNT = [];
    end
    ...
    methods
        function obj = update(obj, ue)
            ...
            obj.MIT_HO_EVENTS = [obj.MIT_HO_EVENTS; ue.MIT_HO_EVENTS];
            obj.MIT_T_BREAK_SUM = [obj.MIT_T_BREAK_SUM; ue.MIT_T_BREAK_SUM];
            obj.MIT_T_PROC_SUM = [obj.MIT_T_PROC_SUM; ue.MIT_T_PROC_SUM];
            obj.MIT_T_INTERRUPT_SUM = [obj.MIT_T_INTERRUPT_SUM; ue.MIT_T_INTERRUPT_SUM];
            obj.MIT_T_RACH_SUM = [obj.MIT_T_RACH_SUM; ue.MIT_T_RACH_SUM];
            obj.MIT_T_HC_SUM = [obj.MIT_T_HC_SUM; ue.MIT_T_HC_SUM];
            obj.MIT_TOTAL_SUM = [obj.MIT_TOTAL_SUM; ue.MIT_TOTAL_SUM];
            obj.RACH_RB_EQ_SUM = [obj.RACH_RB_EQ_SUM; ue.RACH_RB_EQ_SUM];
            obj.DYN_GRANT_TX_COUNT = [obj.DYN_GRANT_TX_COUNT; ue.DYN_GRANT_TX_COUNT];
            obj.DYN_GRANT_FAIL_COUNT = [obj.DYN_GRANT_FAIL_COUNT; ue.DYN_GRANT_FAIL_COUNT];
            obj.DYN_GRANT_FALLBACK_COUNT = [obj.DYN_GRANT_FALLBACK_COUNT; ue.DYN_GRANT_FALLBACK_COUNT];
        end
